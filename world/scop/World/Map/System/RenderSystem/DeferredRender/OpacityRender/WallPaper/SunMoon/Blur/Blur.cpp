...
void Blur::makeFilter()
{
	...
	this->down_filter.push_back(
		make_shared<Filter>(
			w, h,
			L"shader/World/DeferredShader/SkyBox/SunMoon/Sampling/SamplingVS.hlsl",
			L"shader/World/DeferredShader/SkyBox/SunMoon/Sampling/SamplingPS.hlsl"
		)
	);
	this->up_blur_x_filter.push_back(
		make_shared<Filter>(
			w, h,
			L"shader/World/DeferredShader/SkyBox/SunMoon/Sampling/SamplingVS.hlsl",
			L"shader/World/DeferredShader/SkyBox/SunMoon/Blur/BlurXPS.hlsl"
		)
	);
	this->up_blur_y_filter.push_back(
		make_shared<Filter>(
			w, h,
			L"shader/World/DeferredShader/SkyBox/SunMoon/Sampling/SamplingVS.hlsl",
			L"shader/World/DeferredShader/SkyBox/SunMoon/Blur/BlurYPS.hlsl"
		)
	);
