...
ResultSM::ResultSM(UINT width, UINT height)
{
	...
	this->vertex_sahder = make_shared<VertexShader>(
		device,
		L"shader/World/DeferredShader/SkyBox/SunMoon/SemiCombine/SemiCombineVS.hlsl",
		"main",
		"vs_5_0"
	);
	...
	this->pixel_shader = make_shared<PixelShader>(
		device,
		L"shader/World/DeferredShader/SkyBox/SunMoon/SemiCombine/SemiCombinePS.hlsl",
		"main",
		"ps_5_0"
	);
